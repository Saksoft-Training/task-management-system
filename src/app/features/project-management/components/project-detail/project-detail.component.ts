...
export class ProjectDetailComponent implements OnInit, OnDestroy {
  ...
  this.cdr.detectChanges();
    ...
    // Subscribe to task stream — keeps task list in sync with API
  ...
  /** Navigates to task creation page with projectId prefilled. */
  ...
  /** Closes deletion dialog without performing delete. */
  ...
  /**
   * @summary Returns a safe CSS class based on project status.
   * Converts:
  ...
  /** Opens task detail card modal. */
  public openTaskCard(task: Task): void {
    this.activeTask = task;
  }

  /** Closes task detail card modal. */
